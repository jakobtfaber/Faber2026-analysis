...
try:
    ...
    from radio_pipeline.utils.reporting import print_fit_summary
    ...
    try:
        from radio_pipeline.scattering.scat_analysis.pipeline import BurstPipeline
        from radio_pipeline.scattering.scat_analysis.burstfit_corner import (
            quick_chain_check,
            get_clean_samples,
            make_beautiful_corner,
        )
