...
ROUTE_A_JSON = REPO / "scattering" / "studies" / "beta-proof-of-concept" / "freya" / "freya_beta_poc_fit_real.json"
ROUTE_B_NPZ = (
    REPO
    / "scattering"
    / "studies"
...
OUT_JSON = REPO / "scattering" / "studies" / "beta-proof-of-concept" / "freya" / "freya_route_a_vs_b.json"
...
def _load_comparator():
    spec = importlib.util.spec_from_file_location(
        "posterior_compare",
        REPO / "scattering" / "studies" / "joint-refits" / "posterior_compare.py",
    )
