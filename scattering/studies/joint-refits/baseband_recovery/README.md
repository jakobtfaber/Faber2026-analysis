...
scp analysis/scattering/studies/joint-refits/baseband_recovery/upchannelize_chime.py h17:/data/jfaber/
...
scp 'h17:/data/research/astrophysics/frbs/chime-dsa-codetections/upchan_codetections/*_chime_*.npy' \
    analysis/scattering/studies/joint-refits/baseband_recovery/products/
```
...
|-----------|---------------------|
| worker script (repo) | `analysis/scattering/studies/joint-refits/baseband_recovery/upchannelize_chime.py` |
...
casey products are pulled to `analysis/scattering/studies/joint-refits/baseband_recovery/products/`
