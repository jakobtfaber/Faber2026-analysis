...
Numbers + provenance (all in-repo unless flagged):
  ...
  host z         : z=0.5100 (spectroscopic; Connor+2024), foregrounds/census/config.py.
...
def fig():
    ...
    z_fid = 0.5100
    D_A_src_mpc = (
        1311.2  # D_A(z=0.5100), Planck18 (spectroscopic; Connor+2024, foregrounds/census/config.py)
    )
    nu_hz = F_DSA * 1e9
