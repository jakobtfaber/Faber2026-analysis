...
Run from the repo root in the `flits` env:
    python -m analysis.scattering/studies/joint-refits.validate_shared_zeta   # (hyphens: see below)
or directly:
    python analysis/scattering/studies/joint-refits/validate_shared_zeta.py
"""
