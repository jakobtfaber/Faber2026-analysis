...
Rewrites analysis/scattering/studies/joint-refits/citable_alpha_roster.json (the path
...
REPO = HERE.parents[1]
ROSTER = REPO / "analysis" / "scattering/studies/joint-refits" / "citable_alpha_roster.json"
FITS_DIR = HERE / "fits"
