...
| `scattering/studies/joint-refits/_a1_fits` | `scattering/2026-06_refit/_a1_fits` |
| `scattering/studies/joint-refits/joint_json` | `scattering/2026-06_refit/joint_json` |
...
| `../.archive/outdated-science/2026-07-17/` | committed in-tree archive; obsolete science bytes retained for re-examination, never current claims |
