...
| `f3-consistency-audit` | F3 manuscript consistency audit | synthesis | done | devin | [#57](https://github.com/jakobtfaber/Faber2026/issues/57) | `ms/f3-consistency-audit` | [#64](https://github.com/jakobtfaber/Faber2026/pull/64) | yes | PR #64 open; defer budget.tex alpha=4 wording to owner/scattering gate |
