...
- Status: open
- Assignee: —
- Blocked by: [20](20-rebuild-upchannelized-products.md)
- Blocks: [02](02-ratify-chime-scintillation-method.md)
...
ratification grilling (ticket 02, currently blocked) resumes with clean
evidence: method + verdicts, τ·Δν_d still excluded until the scattering
stratum ratifies. PR #140 stays do-not-merge until this campaign's artifacts
replace its staged figures.
