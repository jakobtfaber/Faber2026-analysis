...
**Related Documents:**
- [Research: DM measurement methods](research-dm-measurement-methods.md)
...
(Anchors in [research-dm-measurement-methods.md](research-dm-measurement-methods.md).)
...
- [x] Uniform batch runner `dm_campaign/run_battery.py` over
  ...
  `docs/rse/specs/dm-battery-<method>-contact-sheet.png` + memo.
...
- [ ] Master contact sheet per burst (all methods side-by-side, both
  instruments) → `docs/rse/specs/dm-campaign-burst-sheets/` + summary memo
  `docs/rse/specs/dm-campaign-synthesis-memo.md` (includes chromatica
