...
**Related Documents:**
- [Research: Deterministic host-DM convolution](research-dm-host-convolution.md)
...
- [x] Record runtime, lock/environment, code commits, input SHA-256 hashes,
  ...
  `docs/rse/specs/implement-dm-host-convolution.md`.
- [x] Reproduce from fresh FLITS and parent worktrees and compare CSV/table bytes
  plus numerical summaries.
- [x] Write `docs/rse/specs/validation-dm-host-convolution.md` against this plan.
