...
|------|--------|----------|
| P6.1 anchor inventory | ✅ Complete | DSA DM origin (`bursts.yaml`, catalog, 0.1 placeholder err); CHIME origin (`chime_side_inputs.json`, arrival-time regression, 8/12 constrained); report reproduces at pin. In [v6-association-dm-report-2026-07-07.md](v6-association-dm-report-2026-07-07.md). |
...
- [v6-association-dm-report-2026-07-07.md](v6-association-dm-report-2026-07-07.md) — the V6 deliverable report.
