...
|------|--------|----------|
| P6.1 anchor inventory | ✅ Complete | DSA DM origin (`bursts.yaml`, catalog, 0.1 placeholder err); CHIME origin (`chime_side_inputs.json`, arrival-time regression, 8/12 constrained); report reproduces at pin. In [v6-association-dm-report-2026-07-07.md](../archive/dm/v6-association-dm-report-2026-07-07.md). |
...
| P6.2 agreement figure | ✅ Complete | `crossmatching/dm_agreement.png` → copied to `docs/rse/specs/v6-dm-agreement.png`. |
...
- [plan-trust-reset-revalidation.md](plan-trust-reset-revalidation.md) — Phase 6 spec (P6.1–P6.3).
- [v6-association-dm-report-2026-07-07.md](../archive/dm/v6-association-dm-report-2026-07-07.md) — the V6 deliverable report.
- [dm-provenance-audit-2026-07-07.md](dm-provenance-audit-2026-07-07.md) — sibling DM audit (codex).
