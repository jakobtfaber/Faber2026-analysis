...
**Related Documents:**
- [Triage: Kulkarni-persona feedback (2026-07-17)](triage-kulkarni-feedback-2026-07-17.md) — Thread 1 = "RM → intervening cluster/CGM B-field", verdict *Chase (strongest; cross-paper seam)*
- [Experiment record: X-ray/SZ mass bound (Kulkarni S1)](experiment-cluster-xray-sz-mass-bound-2026-07-17.md) — supplies the X-ray-capped cluster mass and the truncated-prior DM bracket this plan consumes
- [Plan: S1 mass bound](plan-cluster-xray-sz-mass-bound-2026-07-17.md) — the predeclared-record precedent this plan mirrors
- [Handoff 2026-07-17 12:58](handoff-2026-07-17-12-58-s1-landed-owner-decisions-closed.md) — declares Thread 1 the hot lane
...
- A committed JSON artifact
  ...
  table.
- A record figure (`docs/rse/specs/thread1-figures/rm_repartition_sensitivity.pdf`,
...
- A coordination memo (`docs/rse/specs/memo-thread1-rm-repartition-<date>.md`)
...
**Tasks:**
- [ ] **Draft** `docs/rse/specs/memo-thread1-rm-repartition-2026-07-XX.md`:
...
- [Triage: Kulkarni feedback](triage-kulkarni-feedback-2026-07-17.md) · [S1 plan](plan-cluster-xray-sz-mass-bound-2026-07-17.md) · [S1 experiment record](experiment-cluster-xray-sz-mass-bound-2026-07-17.md) · [Handoff 12:58](handoff-2026-07-17-12-58-s1-landed-owner-decisions-closed.md)
