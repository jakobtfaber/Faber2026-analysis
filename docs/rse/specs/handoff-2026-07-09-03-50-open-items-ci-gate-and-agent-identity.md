...
**Runbook:**
- [`runbook-2026-07-09-agent-identity-and-merge-gate.md`](runbook-2026-07-09-agent-identity-and-merge-gate.md) — owner-only steps to split the agent principal from the owner and make review a real gate. **On PR #63, not yet on `main`.**
...
- `docs/rse/specs/runbook-2026-07-09-agent-identity-and-merge-gate.md` (**PR #63 only**) — why a merge gate needs two principals before it means anything.
...
- `docs/rse/specs/runbook-…-agent-identity-and-merge-gate.md` (**#63**) — new, docs-only.
