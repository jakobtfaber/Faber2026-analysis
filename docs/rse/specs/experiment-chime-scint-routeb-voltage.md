...
**Related documents:**
- [Gate 0 detectability](experiment-chime-scint-gate0-detectability.md) — GO with admissibility window
- [Successor-route assessment (sanctioned)](research-chime-scint-successor-routes.md)
- [C1 blinded calibration](experiment-chime-scint-c1-calibration.md) — the freeze/calibrate/null/unblind template this record follows
---
