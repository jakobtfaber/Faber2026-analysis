...
**Related Documents:**
- [Decision: Figure 1 + CHIME C1 route (OWNER, governs this plan)](../decision/decision-2026-07-14-figure1-and-chime-c1.md)
...
- [x] **Go/no-go.** PASS (every prerequisite, null, and every `m=0.15` and
  ...
  way: `docs/rse/specs/experiment/experiment-chime-scint-c1-calibration.md` records
