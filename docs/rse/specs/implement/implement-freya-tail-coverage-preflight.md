...
**Plan Reference:** dsa110-FLITS issue #101 + its Agent Brief (the tracker issues are the plan); PRD "deep module 1" in [prd-freya-beta-comodel-real-data-fit.md](../prd/prd-freya-beta-comodel-real-data-fit.md).
