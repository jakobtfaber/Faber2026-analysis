...
**Status:** Draft
**Related Documents:**
- [Research: DM_IGM PDF / Connor 2024](research-dm-igm-pdf-connor2024.md)
...
- [ ] **Supersession note** (pipeline-side stale doc):
      ...
      (Faber2026 docs/rse/specs/plan-dm-igm-pdf-connor2024.md).`
...
- [ ] Stale-doc annotation:
      `docs/rse/specs/plan-trust-reset-revalidation.md:1102` — prepend
...
- [ ] Pipeline `docs/superpowers/plans/2026-06-19-...md:387` superseded note
      (Phase 4).
- [ ] `docs/rse/specs/plan-trust-reset-revalidation.md:1102` superseded note
      (Phase 6).
