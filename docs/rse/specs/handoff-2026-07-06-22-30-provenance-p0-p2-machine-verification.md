...
**Plan Documents:**
- [plan-trust-reset-revalidation.md](plan-trust-reset-revalidation.md) — the §V re-validation program being executed (P0.x/P1.x/P2.x…P6.x)
- [plan-circulation-readiness.md](plan-circulation-readiness.md) — parent plan; §V is gate zero

**Research Documents:**
- [research-trust-reset-revalidation.md](research-trust-reset-revalidation.md) — V1–V6 surfaces map (defects, gates, rail definitions)
- [machine-inventory-verification-2026-07-06.md](machine-inventory-verification-2026-07-06.md) — **produced this session**; live-verified host table + closures appendix

**Previous Handoffs (context chain):**
- [handoff-2026-07-06-14-50-chime-sample-regeneration.md](handoff-2026-07-06-14-50-chime-sample-regeneration.md) — the h17 upchan regeneration campaign (separate scint lineage)

## Critical References

1. `docs/rse/specs/machine-inventory-verification-2026-07-06.md` — verified host topology + what was closed and how; read first.
2. `docs/rse/specs/plan-trust-reset-revalidation.md:158-891` — Phases 0–2; P0.2/P0.3/P0.4/P2.3/P2.4 are the specified next tasks.
