...
|---|--------|-----------|-------------------|
| 1 | wayfinder ticket 17 | L0: certify bytes/lineage/axis conventions, all 36 products; convention tests in CI | spot-check |
...
> Follow the resume pointer: start with ticket 17 (certify the raw data
> layer), then proceed down the stratum chain. When stratum 2 opens, read
> handoff-2026-07-19-14-56 and show the owner
> `docs/rse/decks/casey-dm-calibration-2026-07-19/casey_dm_strip_CORRECTED.png`
> full-size before asking anything.
