...
**Experiment Reports:**
- [experiment-freya-chime-instrumental-origin.md](../experiment/experiment-freya-chime-instrumental-origin.md) — arms A–I incl. B1 masking oracle (35.19 → 42.21 kHz @ ±0.05 MHz) that this session's config enablement operationalizes
- [experiment-freya-chime-dnu-science-readiness.md](../experiment/experiment-freya-chime-dnu-science-readiness.md) — the retraction context: freya CHIME 35 kHz is instrumental, not scintillation

**Previous Handoffs (same lane):**
- [handoff-2026-07-05-14-34-freya-chime-e3-reversal.md](../handoff/handoff-2026-07-05-14-34-freya-chime-e3-reversal.md) — E3 ν^4.4 reversal closeout that preceded this work
