...
- **PR #64** → `docs/rse/specs/handoff/handoff-2026-07-09-03-50-open-items-ci-gate-and-agent-identity.md` — **the authority on all open items.** Covers PRs #59, #63, the iTerm Diff-pane fix, and `repro_manifest.csv` verification. On branch `docs/handoff-open-items`, not yet on `main`.
...
- `docs/rse/specs/runbook/runbook-2026-07-09-agent-identity-and-merge-gate.md` — owner-only steps to split the agent principal from the owner so review becomes a real gate.
