...
- [handoff-2026-07-08-18-12-b7-cgm-census-resolved.md](../handoff/handoff-2026-07-08-18-12-b7-cgm-census-resolved.md) — B7 CGM census; **updated this session** with the #40 blocker, the B3 reframing, the spline defect, and corrected git state. Committed in `35abbbd`.
- [handoff-2026-07-08-08-55-open-author-decisions.md](../handoff/handoff-2026-07-08-08-55-open-author-decisions.md) — the original B3/B7/DM item list. Its Item 1 (B3) *diagnosis* is superseded; see "The B3 reframing" below.
