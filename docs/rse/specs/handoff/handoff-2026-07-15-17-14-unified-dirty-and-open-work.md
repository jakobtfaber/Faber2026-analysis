...
|------|----------------|--------|
| `docs/rse/specs/plan/plan-manuscript-science-gates-2026-07-15.md` | Intentional plan (Draft) | Include in optional docs-only PR from fresh `origin/main` branch |
| `docs/rse/specs/handoff/handoff-2026-07-15-17-12-manuscript-science-gates.md` | Intentional science-gate handoff | Same docs PR |
| `docs/rse/specs/handoff/handoff-2026-07-15-16-44-dm-host-budget-clarify.md` | Archival; method description **superseded** by #98 convolution | Optional archival in same docs PR; do not treat as live method |
| `docs/rse/specs/handoff/handoff-2026-07-15-17-14-unified-dirty-and-open-work.md` | This file | Same docs PR |
...
- [plan-manuscript-science-gates-2026-07-15.md](../plan/plan-manuscript-science-gates-2026-07-15.md) — unified G0–G8 science plan
- [handoff-2026-07-15-17-12-manuscript-science-gates.md](../handoff/handoff-2026-07-15-17-12-manuscript-science-gates.md) — science-gate execution handoff
- [handoff-2026-07-15-17-14-unified-dirty-and-open-work.md](../handoff/handoff-2026-07-15-17-14-unified-dirty-and-open-work.md) — this ledger
- [handoff-2026-07-15-16-44-dm-host-budget-clarify.md](../handoff/handoff-2026-07-15-16-44-dm-host-budget-clarify.md) — archival clarify (superseded method)

**Already on `origin/main` (do not redo):**

- [handoff-2026-07-15-16-49-dm-host-convolution.md](../handoff/handoff-2026-07-15-16-49-dm-host-convolution.md) — via PR #101
- [handoff-2026-07-15-16-49-provisional-propagation-next.md](../handoff/handoff-2026-07-15-16-49-provisional-propagation-next.md) — via PR #100
...
- [validation-v3-energetics-2026-07-15.md](../validation/validation-v3-energetics-2026-07-15.md)
- [plan-provisional-joint-scint-twoscreen.md](../plan/plan-provisional-joint-scint-twoscreen.md) — integration **done**
...
1. `docs/rse/specs/handoff/handoff-2026-07-15-17-14-unified-dirty-and-open-work.md` — this ledger (what is dirty vs closed).
2. `docs/rse/specs/plan/plan-manuscript-science-gates-2026-07-15.md` — open gates G1–G7 and fail-closed rules.
3. `docs/rse/specs/handoff/handoff-2026-07-15-17-12-manuscript-science-gates.md` — execution checklist after Phase 0 sync.
