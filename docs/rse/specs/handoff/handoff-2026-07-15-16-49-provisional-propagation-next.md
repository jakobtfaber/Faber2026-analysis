...
- Research: [`research-provisional-joint-scint-twoscreen.md`](../research/research-provisional-joint-scint-twoscreen.md)
- Foreground research: [`research-foreground-propagation-alignment.md`](../research/research-foreground-propagation-alignment.md)
- Implementation plan: [`plan-provisional-joint-scint-twoscreen.md`](../plan/plan-provisional-joint-scint-twoscreen.md)
- Validation: [`validation-provisional-joint-scint-twoscreen.md`](../validation/validation-provisional-joint-scint-twoscreen.md)
