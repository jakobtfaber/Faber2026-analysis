...
- [experiment-chime-scint-p3-optimal-estimator.md](experiment-chime-scint-p3-optimal-estimator.md) — the calibrated estimator this pass replicates per burst (§P3′ amendment = the frozen chain)
- [experiment-chime-scint-p4-envelope-model.md](experiment-chime-scint-p4-envelope-model.md) §Outcome — the envelope-separability precedent (freya)
...
- [handoff-2026-07-15-06-50-p4-envelope-model-dev.md](handoff-2026-07-15-06-50-p4-envelope-model-dev.md) §Learnings — all seven items still bind
