...
- [plan-trust-reset-revalidation.md](plan-trust-reset-revalidation.md) / [research-trust-reset-revalidation.md](research-trust-reset-revalidation.md) — the governance regime (`CONTEXT.md`) that gates which lanes may state sky results. B1/B2 live in the already-cleared budget lane.
- [validation-sightline-halo-grid.md](validation-sightline-halo-grid.md) — foreground-census figure the census items (6–8) touch.
- [handoff-2026-07-07-10-11-v6-phase6-complete.md](handoff-2026-07-07-10-11-v6-phase6-complete.md) — prior V6/Phase-6 handoff (scattering-fit revalidation lane; untouched here).
