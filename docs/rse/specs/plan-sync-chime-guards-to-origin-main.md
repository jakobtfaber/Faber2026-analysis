...
- [x] `git show origin/main:docs/rse/specs/assessment-chatgpt-scint-decombing-review.md | head -1` → `# Assessment: ChatGPT review of the scintillation "de-combing" code`.
