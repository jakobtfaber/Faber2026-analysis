...
**Related documents:**
- [Decision: Figure 1 + CHIME C1 route (owner, 2026-07-14)](../decision/decision-2026-07-14-figure1-and-chime-c1.md) — the stop rule this record extends
- [Plan: corrected CHIME products revival](../plan/plan-chime-scint-corrected-products-revival.md) — P1 design (a v1.2 revision is in flight in a separate worktree; this record governs scope regardless of that revision's final form)
- [Experiment: C1 blinded calibration](../experiment/experiment-chime-scint-c1-calibration.md) — the DOCUMENTED-FAIL record
---
