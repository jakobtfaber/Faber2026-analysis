...
committed, so the summary is reproducible from a clean checkout:
    ...
    python analysis/scattering/studies/legacy-joint-refits/gen_joint_summary.py
...
def render() -> str:
    ...
    L.append(
        ...
        "`analysis/scattering/studies/legacy-joint-refits/joint_json/` (committed)."
    )
    L.append("")
    ...
    L.append("")
    L.append(
        "_Generated by `analysis/scattering/studies/legacy-joint-refits/gen_joint_summary.py` from the "
