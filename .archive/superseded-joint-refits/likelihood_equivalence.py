...
and record the verdict artifact:
    ...
    conda run -n flits python analysis/scattering/studies/legacy-joint-refits/likelihood_equivalence.py
"""
...
def _poc():
    ...
    path = REPO / "scattering" / "studies" / "beta-proof-of-concept" / "run_beta_poc.py"
...
def main(argv=None) -> int:
    ...
    out = (
        ...
        if args.out
            ...
            REPO
            / "analysis"
            / "scattering/studies/legacy-joint-refits"
            / "local_runs"
