...
def destination(path: str) -> tuple[str, str, str, str]:
    ...
    project_prefixes = {
        "crossmatching/": "associations/studies/crossmatching/",
        "galaxies/foreground/data/": "foregrounds/studies/census/data/",
        "notebooks/codetections/": "observations/studies/codetections/notebooks/",
        ...
        "scintillation/scint_analysis/reference_arc/": (
            "scintillation/studies/reference-analysis/reference_arc/"
        ),
        "scripts/h17_codetections/": "observations/studies/codetections/h17/",
    }
    ...
    project_files = {
        ...
        "docs/codetection-science-plan.md": "observations/studies/codetections/codetection-science-plan.md",
        "docs/freya_evidence.html": "scintillation/studies/reference-analysis/freya_evidence.html",
        "galaxies/foreground/budget_table_data.json": (
            "foregrounds/studies/census/budget_table_data.json"
        ),
        "galaxies/foreground/foreground_table_data.json": (
            "foregrounds/studies/census/foreground_table_data.json"
        ),
        "scintillation/freya_analysis_results.json": (
            "scintillation/studies/reference-analysis/freya_analysis_results.json"
        ),
    }
