...
2. Inspect scripts/plot_codetection_gallery.py, pipeline/flits/batch/codetection_plots.py, sections/observations.tex, sections/jointmodel_pairs.tex, sections/results.tex (jointmodel refs), docs/rse/specs/plan-unified-12burst-figure.md, docs/rse/specs/jointmodel-pair-fit-quality-flags.md, and trust-reset bits in CONTEXT.md.
