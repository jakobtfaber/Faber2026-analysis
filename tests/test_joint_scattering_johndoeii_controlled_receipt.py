...
RECEIPT = (
    ROOT
    / "docs/rse/verify/joint-scattering-controlled-rerun-04-johndoeii-c2d2-20260723"
    / "verification-receipt.json"
)
TICKET = (
    ROOT
    / "docs/rse/wayfinder/tickets"
    / "joint-scattering-controlled-rerun-04-regenerate-johndoeii-c2d2.md"
)


def test_johndoeii_receipt_is_reproduced_but_fail_closed() -> None:
    receipt = json.loads(RECEIPT.read_text(encoding="utf-8"))

    assert receipt["morphology"] == "C2D2"
...
def test_johndoeii_ticket_stops_at_scientific_and_visual_gate() -> None:
