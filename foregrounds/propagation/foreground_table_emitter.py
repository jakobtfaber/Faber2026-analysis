...
Usage
-----
    from foregrounds.propagation.foreground_table_emitter import format_foreground_table_tex
    tex = format_foreground_table_tex()

CLI:
    python -m foregrounds.propagation.foreground_table_emitter            # writes exports/foreground_table.tex
    python -m foregrounds.propagation.foreground_table_emitter --check    # parity check, non-zero exit on drift
"""
...
from foregrounds.paths import DATA_DIR, FOREGROUND_TABLE_DATA, RESULTS_ROOT

HERE = pathlib.Path(__file__).resolve().parent
DATA_PATH = FOREGROUND_TABLE_DATA
REGISTRY_PATH = DATA_DIR / "intervening_census_registry.csv"
EXPORT_PATH = RESULTS_ROOT / "generated" / "foreground_table.tex"
...
%    foregrounds/census/foreground_table_data.json; markup in foreground_table_emitter.py.
%    Regenerate: python -m foregrounds.propagation.foreground_table_emitter --out <this file>
%    Object IDs + verdicts are cross-checked against data/intervening_census_registry.csv.
% Foreground census table. Values from the local foreground validation
