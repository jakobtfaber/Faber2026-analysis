...
Run:  uv run --frozen python -m foregrounds.visualization.build_remediated_halo_grid_input \
          --halo-csv <ranked candidates csv> --out <merged csv>
Then: uv run --frozen python -m foregrounds.visualization.sightline_halo_grid \
...
def _budget_contributors() -> list[dict]:
    ...
    from foregrounds.propagation.sightline_budget import foreground_unified
