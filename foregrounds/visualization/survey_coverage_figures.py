...
from foregrounds.census.survey_footprint_mocs import (
    ALL_SKY_SURVEYS,
    DEFAULT_CACHE_DIR,
    load_survey_moc,
    moc_sky_area_deg2,
...
from foregrounds.census.utils import parse_coord
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.prefetch_mocs:
        from foregrounds.census.survey_footprint_mocs import prefetch_all_survey_mocs
