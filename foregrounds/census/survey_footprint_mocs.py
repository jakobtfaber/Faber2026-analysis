...
def moc_cache_path(survey: str, cache_dir: Path | str = DEFAULT_CACHE_DIR) -> Path:
    """Return the canonical cached footprint path without fetching it."""
    return _cache_path(Path(cache_dir), survey)
