...
from foregrounds.census.config import LEGACY_DR9_PHOTOZ_CACHE_ENV, LEGACY_DR9_PHOTOZ_ROOT_URL
from foregrounds.census.engines import BaseEngine, VizierEngine
...
class ClusterEngine(BaseEngine):
    ...
    def __init__(self, catalogs=None):
        if catalogs is None:
            from foregrounds.census.config import CLUSTER_VIZIER_CATALOGS
