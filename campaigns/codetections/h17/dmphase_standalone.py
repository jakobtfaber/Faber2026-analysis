...
K_DM = 4.148808e3  # MHz^2 pc^-1 cm^3 s (inlined; flits not in baseband image)
...
class DMPhaseEstimator:
    ...
    def __init__(
        ...
        # K_DM already in seconds; freqs in MHz -> seconds. (removed spurious 1e-3: was 1000x small)
