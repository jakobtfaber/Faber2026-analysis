...
from campaigns.chime_beam import FWHM_EW_400, FWHM_NS_400
from campaigns.dsa_beam import DEFAULT_BEAM, load_power_beam
from campaigns.flux_cal import dsa_pointing_dec

ROOT = Path(__file__).resolve().parents[2]
HERE = Path(__file__).resolve().parent
OUTDIR = HERE / "association_cards"
# Manuscript figures live beside the analysis checkout when mounted as the
# parent submodule. Override with --manuscript-dir for a standalone checkout.
