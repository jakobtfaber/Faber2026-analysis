...
ROUTE_A_JSON = REPO / "campaigns" / "beta_poc" / "freya" / "freya_beta_poc_fit_real.json"
ROUTE_B_NPZ = (
    REPO
    / "campaigns"
...
OUT_JSON = REPO / "campaigns" / "beta_poc" / "freya" / "freya_route_a_vs_b.json"
...
def _load_comparator():
    spec = importlib.util.spec_from_file_location(
        "posterior_compare",
        REPO / "campaigns" / "scattering-refit-2026-06" / "posterior_compare.py",
    )
