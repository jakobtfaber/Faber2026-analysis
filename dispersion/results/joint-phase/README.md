...
results, provenance, and held-out injection validation for all 12 CHIME+DSA
events.
...
export PYTHONPATH="$PWD/analysis/dispersion/results/joint-phase/code:$PWD/pipeline"

python analysis/dispersion/results/joint-phase/code/scripts/run_joint_dm_phase.py \
  --manifest data/catalog/data-manifest.csv \
  --output analysis/dispersion/results/joint-phase/results/fits.json

python analysis/dispersion/results/joint-phase/code/scripts/validate_joint_dm_phase.py \
  --output analysis/dispersion/results/joint-phase/results/validation

python analysis/dispersion/results/joint-phase/code/scripts/render_joint_dm_diagnostics.py \
  --results analysis/dispersion/results/joint-phase/results/fits.json \
  --output analysis/dispersion/results/joint-phase/results/diagnostics

python analysis/dispersion/results/joint-phase/code/scripts/write_joint_dm_provenance.py \
  --results analysis/dispersion/results/joint-phase/results/fits.json \
  --output analysis/dispersion/results/joint-phase/results/run_provenance.json

pytest -q \
  analysis/dispersion/results/joint-phase/code/tests/test_dm_joint_phase.py \
  analysis/dispersion/results/joint-phase/code/tests/test_dmphase_recovery.py
```
