...
`analysis/scattering/studies/joint-refits/run_joint_fit.py`, `joint_json/*_joint_fit.json`.
...
3. **`c0_C` and `c0_D` show no common scale** (medians; source:
   `analysis/scattering/studies/joint-refits/joint_json/*_joint_fit.json` →
