...
async function main() {
  ...
  const burstsCsvPath = path.join(__dirname, '../foregrounds/census/data/frozen_census/bursts.csv');
  const registryCsvPath = path.join(__dirname, '../foregrounds/census/data/intervening_census_registry.csv');
